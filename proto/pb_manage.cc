...
PBManage::PBManage(const std::string &pb_dir, const std::string &pb_file_name) : pb_dir_(pb_dir), pb_file_name_(pb_file_name), source_tree_(), collector_(), importer_(&source_tree_, &collector_)
{/*{{{*/
