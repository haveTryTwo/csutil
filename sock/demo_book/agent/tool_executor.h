...
#ifndef SOCK_DEMO_BOOK_AGENT_TOOL_EXECUTOR_H_
#define SOCK_DEMO_BOOK_AGENT_TOOL_EXECUTOR_H_
 ...
 *   - list_books(prefix?, limit?) / get_book(book_id)：查 demo 业务库（经网关注入的回调调 Control RPC）
