...
const char kToolsSchema[] =
    ...
    "\"description\":\"列出 demo 业务库中的图书（按 book_id 字典序分页，可按前缀过滤）。\","
    "\"parameters\":{\"type\":\"object\",\"properties\":{"
    "\"prefix\":{\"type\":\"string\",\"description\":\"可选，book_id 前缀过滤\"},"
    "\"limit\":{\"type\":\"integer\",\"description\":\"可选，单页最大条数（默认 20，上限 50）\"},"
    "\"start_after\":{\"type\":\"string\",\"description\":\"可选，分页游标：上一页返回的 next_cursor（本页不含该 book_id）\"}}}}},"
