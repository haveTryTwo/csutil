...
#ifndef MY_HASH_MULTISET_H_
#define MY_HASH_MULTISET_H_
...
class my_hash_multiset {
 ...
 public:
  ...
  template <class InputIterator>
  my_hash_multiset(InputIterator first, InputIterator last, size_type n)
 ...
 public:
  ...
  void swap(my_hash_multiset& hs) { rep.swap(hs.rep); }
 ...
 public:
  ...
  friend bool operator==(const my_hash_multiset<V, H, E, A>& hs1,
                         const my_hash_multiset<V, H, E, A>& hs2);
};
