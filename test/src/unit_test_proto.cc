...
{/*{{{*/
    ...
    std::string source_json = "{\"name\":\"æµè¯unicodeé ·unicodeæµè¯\",\"birthday\":1,\"is_student\":false,\"resv1\":\"good one\",\"resv2\":1234605616436508552,\"resv3\":-139292509886650761,\"RESV4\":-139292509886650761,\"health_status\":102}";
...
{/*{{{*/
    ...
    fprintf(stderr, "src_num:%#lx,%ld, little_param:%lu, big_param:%ld\n",
        src_num, src_num, little_param.num(), big_param.num());
}/*}}}*/
...
{/*{{{*/
    ...
    fprintf(stderr, "src_num:%u, little_param:%s, err_param:%s\n",
        src_num, little_param.DebugString().c_str(), err_param.DebugString().c_str());
}/*}}}*/
