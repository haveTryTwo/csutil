...
HttpBusiClient::HttpBusiClient(const std::string &client_name) : BusiClient(client_name), is_init_(false), http_type_(base::GET) 
{/*{{{*/
}/*}}}*/
...
base::Code HttpBusiClient::SendAndRecv(const std::string &req_relative_url, const std::string &post_params, std::string *resp)
{/*{{{*/
