...
StatInfo::StatInfo()
    : model(""),
      ...
      min_time(0),
      total_time(0),
      time_out_level_one_num(0),
      time_out_level_two_num(0),
      time_out_level_three_num(0),
      total_recv_flow(0),
      total_send_flow(0) {}
...
Code Statistic::AddStat(const std::string &model, int ret_code, timeval start, timeval end, int recv_flow,
  ...
  if (it != stat_list_.end()) {
    ...
    if (diff_time >= time_out_level_three_ * 1000)
      it->second.time_out_level_three_num++;
    else if (diff_time >= time_out_level_two_ * 1000)
      it->second.time_out_level_two_num++;
    else if (diff_time >= time_out_level_one_ * 1000)
      it->second.time_out_level_one_num++;
  ...
  if (diff_time >= time_out_level_three_ * 1000)
    stat_info.time_out_level_three_num++;
  else if (diff_time >= time_out_level_two_ * 1000)
    stat_info.time_out_level_two_num++;
  else if (diff_time >= time_out_level_one_ * 1000)
    stat_info.time_out_level_one_num++;
