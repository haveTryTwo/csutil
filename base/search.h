...
Code BinaryDescendSearch(RandomIterator first, RandomIterator last, const T &data, RandomIterator *pos, Compare comp)
{/*{{{*/
...
template <typename RandomIterator, typename T>
Code BinaryAscendSearch(RandomIterator first, RandomIterator last, const T &data, RandomIterator *pos, Compare comp)
{/*{{{*/
    if (first > last || pos == NULL) return kInvalidParam;
