 ...
 *polynomialx^32 + x^26 + x^23 + x^22 + x^16 +
 *16x^12 + x^11 + x^10 + x^8 + x^7 + x^5 + x^4 + x^2 + x^1 + 1
 */
...
uint32_t CRC32(const char *str, int len) { /*{{{*/
  uint32_t crc32_val = 0 ^ 0xFFFFFFFF;
  for (int i = 0; i < len; ++i) {
    crc32_val = crc32_tab[(crc32_val ^ str[i]) & 0xFF] ^ ((crc32_val >> 8) & 0x00FFFFFF);
  }
...
int main(int argc, char *argv[]) { /*{{{*/
  ...
  uint32_t crc32_val = CRC32(str.data(), str.size());
